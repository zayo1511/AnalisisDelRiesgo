...
$$\sigma_t^2=w+\alpha_1R_{t-1}^2+\alpha_2R_{t-1}^2$$
...
$$\sigma_t^2=w+\alpha_1R_{t-1}^2+\beta_1R_{t-1}^2$$
...
$$\sigma_t^2=w+\alpha_1R_{t-1}^2+\beta_1R_{t-1}^2+\beta_2R_{t-1}^2$$
...
$$\sigma_t^2=w+\alpha_1R_{t-1}^2+\alpha_2R_{t-1}^2+\beta_1R_{t-1}^2$$
...
$$\sigma_t^2=w+\alpha_1R_{t-1}^2+\alpha_2R_{t-1}^2+\beta_1R_{t-1}^2+\beta_2R_{t-1}^2$$
