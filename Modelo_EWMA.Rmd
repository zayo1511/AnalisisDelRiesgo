...
Se calcula la funacionde vorismilitud dado un valor arbitrario de $\lambda$. Ya que se busca el óptimo se crea un for anidado donde se prueban los diferentes valores de lambda.
